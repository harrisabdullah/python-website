...
#undef MODULE_DEF_JS
#define MODULE_DEF_JS { MP_ROM_QSTR(MP_QSTR_js), MP_ROM_PTR(&mp_module_js) },

extern const struct _mp_obj_module_t mp_module_jsffi;
#undef MODULE_DEF_JSFFI
#define MODULE_DEF_JSFFI { MP_ROM_QSTR(MP_QSTR_jsffi), MP_ROM_PTR(&mp_module_jsffi) },
...
#define MICROPY_HAVE_REGISTERED_EXTENSIBLE_MODULES  15
...
extern void mp_module_js_attr(mp_obj_t self_in, qstr attr, mp_obj_t *dest);
extern void mp_module_sys_attr(mp_obj_t self_in, qstr attr, mp_obj_t *dest);
#define MICROPY_MODULE_DELEGATIONS \
    { MP_ROM_PTR(&mp_module_js), mp_module_js_attr }, \
